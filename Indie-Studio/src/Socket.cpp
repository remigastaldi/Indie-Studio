...
** Last update Tue May 30 14:26:06 2017 gastal_r
*/
...
void Socket::events()
{
                                                                        ...
                                                                        bool isAck, const sio::message::list &ack_resp)
        {
                ...
                if ((data->get_map()["send_to"]->get_int() == 0 || data->get_map()["send_to"]->get_int() == _id) && data->get_map()["send_by"]->get_int() != _id)
                {
                  ...
                  _entity[data->get_map()["send_by"]->get_int()] = createEntity(Entity::Type::RANGER, *mDevice->sceneMgr, *_collision, data->get_map()["send_by"]->get_int(),
